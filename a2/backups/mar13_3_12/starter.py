...
def NN_tf(X_train, Y_train, X_valid, Y_valid, X_test, Y_test, epochs, batchSize, lr, noOfImages, lambda_val,rate):
    ...
    #initialize parameter x, y placeholders
...
def main():
    ...
    '''PART2'''
    NN_tf(X_train, Y_train, X_valid, Y_valid, X_test, Y_test, epochs=50, batchSize=32, lr=0.0001, noOfImages=10,lambda_val=0.01,rate=1)
